...
import 'package:themoviedb/domain/entities/movie_details_videos.dart';

part 'movie_details.g.dart';

//вставил джсон с API и командой превратил его в MovieDetails class

@JsonSerializable(fieldRename: FieldRename.snake, explicitToJson: true)
class MovieDetails {
  //нужно пробежаться по API и пометить нуловые поля
  final bool adult;
  ...
  //в этих листах тоже проверить нулы
