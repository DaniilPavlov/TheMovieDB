  ...
  Widget build(BuildContext context) {
    return ColoredBox(
      ...
      child: Padding(
        ...
        child: Text(
          '18+ боевик, комедия, хоррор, научная фантастика, 17520 часов',
          style: TextStyle(
            fontSize: 16,
            color: AppColors.titleColorMovieDetail,
          ),
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          ...
          ' Морти — самый обычный мальчик, который ничем не отличается от '
          'своих сверстников. А вот его дедуля занимается необычными '
          'научными исследованиями и зачастую полностью неадекватен. '
          'Он может в любое время дня и ночи схватить внука и отправиться '
          'вместе с ним в межпространственные приключения с помощью '
          'построенной из разного хлама летающей тарелки, которая '
          'способна перемещаться сквозь временной тоннель. Каждый раз эта '
          'парочка оказывается в самых неожиданных местах и самых нелепых '
          'ситуациях.',
          style: TextStyle(
            fontSize: 16,
            color: AppColors.titleColorMovieDetail,
